    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#000000] px-4">
            <motion.div
                ...
                className="w-full max-w-md bg-[#fc8200] rounded-2xl shadow-xl p-8 md:p-10"
            >
                {/* Logo */}
                        ...
                        <div className="grid grid-cols-4 gap-3">
                            {[
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="flex cursor-pointer items-center justify-center h-11 rounded-lg border border-border bg-background hover:bg-accent/50 transition-colors"
